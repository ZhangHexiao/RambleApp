...
public class StarRateView: UIView {
    ...
    /// 默认整颗星星
    lazy var starType:StarType = .default
    ...
    public override convenience init(frame: CGRect) {
        self.init(frame:frame, totalStarCount:5.0, starSpace:5.0)
    }
    
    public init(frame: CGRect, totalStarCount: CGFloat, starSpace: CGFloat) {
        ...
        unStarView = setupStarView(image: #imageLiteral(resourceName: "ic_star_selected"), count: 5.0)
        addSubview(unStarView)
        starView = setupStarView(image: #imageLiteral(resourceName: "rating_star"), count: 0.0 )
        insertSubview(starView, aboveSubview: unStarView)
        showStarRate()
    }
    
    public init(frame: CGRect, totalStarCount: CGFloat, starSpace: CGFloat, currentStarCount: CGFloat) {
        ...
        unStarView = setupStarView(image: #imageLiteral(resourceName: "ic_star_selected"), count: 5.0)
        addSubview(unStarView)
        starView = setupStarView(image: #imageLiteral(resourceName: "rating_star") ,count: currentStarCount)
        insertSubview(starView, aboveSubview: unStarView)
        showStarRate()
    }
...
extension StarRateView{
    ...
    /// 绘制星星UI
    fileprivate func setupStarView(image: UIImage, count: CGFloat) -> UIView {
